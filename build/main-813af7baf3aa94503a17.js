	  ...
	  submitPart: function submitPart(e) {
	    ...
	    fetch('/new_part', {
	      ...
	      body: JSON.stringify({
	        ...
	        partNumber: 'Acadia',
	        hasSerialNumber: 'Acadia',
	        partSerialNumber: 'Acadia',
	        quantity: 'Acadia'
	      })
	    });
	  },
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              ...
	              React.createElement(
	                'label',
	                null,
	                React.createElement('input', { type: "checkbox", name: "hasSerialNumber" }),
	                ' ',
	                'Has serial number'
	              )
	            ),
	            ...
	            React.createElement(
	              ...
	              React.createElement('input', { type: "number", className: "form-control", placeholder: 1, name: "quantity" })
	            ),
	            React.createElement(
	              'button',
