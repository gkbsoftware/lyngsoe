...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Note = __webpack_require__(157);
	var NewPart = __webpack_require__(159);
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(Note, { key: "thisKey", name: "Notes" }),
	          React.createElement(NewPart, { emailAddress: "Enter your email here" })
	        )
	      )
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NewPart = React.createClass({
	  ...
	  submitPart: function submitPart(e) {
	    e.preventDefault();
	    ...
	    fetch('/new_part', {
	      ...
	      body: JSON.stringify({
	        ...
	        serialNumber: this.refs.partName.getDOMNode().value,
	        quantity: this.refs.partName.getDOMNode().value
	      })
	    });
	  },
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              ...
	              React.createElement('input', { className: "form-control", placeholder: "Input Part Name", name: "partName", ref: "partName" })
	            ),
	            React.createElement(
	              'div',
	              { className: "form-group" },
	              ...
	              React.createElement('input', { className: "form-control", placeholder: "Input Part Number", name: "partNumber", ref: "partNumber" })
	            ),
	            React.createElement(
	              'div',
	              { className: "checkbox" },
	              React.createElement(
	                'label',
	                null,
	                React.createElement('input', { type: "checkbox", name: "hasSerialNumber", ref: "hasSerialNumber" }),
	                ' ',
	                'Has serial number'
	              )
	            ),
	            React.createElement(
	              ...
	              React.createElement('input', { className: "form-control", placeholder: "Input Serial Number", name: "serialNumber", ref: "serialNumber" })
	            ),
	            React.createElement(
	              'div',
	              { className: "form-group" },
	              ...
	              React.createElement('input', { type: "number", className: "form-control", placeholder: 1, name: "quantity", ref: "quantity" })
	            ),
	            React.createElement(
	              'button',
