	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              ...
	              React.createElement("input", { className: "form-control", placeholder: "Part Name", name: "partName" }),
	              React.createElement("input", { className: "form-control", placeholder: "Part Number", name: "partNumber" })
	            ),
	            React.createElement(
	              "div",
	              { className: "form-group" },
